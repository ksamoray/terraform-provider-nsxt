...
// testAccNsxtPolicyDistributedVxlanConnectionRcTemplate returns HCL that
// creates a VNA cluster (via testAccNsxtPolicyRouteControllerVnaTemplate) and
// an nsxt_policy_route_controller named "rc" on top of it. All DVXC templates
