...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"nsxt_policy_gateway_security_config":                       dataSourceNsxtPolicyGatewaySecurityConfig(),
			...
			"nsxt_policy_idps_custom_signature":                         dataSourceNsxtPolicyIdpsCustomSignature(),
			"nsxt_policy_idps_settings":                                 dataSourceNsxtPolicyIdpsSettings(),
			"nsxt_policy_idps_signature_diff":                           dataSourceNsxtPolicyIdpsSignatureDiff(),
			...
			"nsxt_policy_ipsec_vpn_dpd_profile":                         dataSourceNsxtPolicyIPSecVpnDpdProfile(),
			...
			"nsxt_policy_route_controller":                              dataSourceNsxtPolicyRouteController(),
			"nsxt_policy_route_controller_bgp_neighbor":                 dataSourceNsxtPolicyRouteControllerBgpNeighbor(),
			"nsxt_policy_route_controller_interface":                    dataSourceNsxtPolicyRouteControllerInterface(),
			...
			"nsxt_policy_tier0_gateways":                                dataSourceNsxtPolicyTier0Gateways(),
			...
			"nsxt_policy_user_management_role_binding":                  dataSourceNsxtPolicyRoleBinding(),
			"nsxt_policy_virtual_network_appliance":                     dataSourceNsxtPolicyVirtualNetworkAppliance(),
			"nsxt_policy_virtual_network_appliance_cluster":             dataSourceNsxtPolicyVirtualNetworkApplianceCluster(),
			"nsxt_policy_virtual_network_appliance_cluster_realization": dataSourceNsxtPolicyVirtualNetworkApplianceClusterRealization(),
			...
			"nsxt_proxy_config":                                         dataSourceNsxtProxyConfig(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"nsxt_policy_gateway_security_config":                      resourceNsxtPolicyGatewaySecurityConfig(),
			...
			"nsxt_policy_idps_custom_signature":                        resourceNsxtPolicyIdpsCustomSignature(),
			"nsxt_policy_idps_settings":                                resourceNsxtPolicyIdpsSettings(),
			"nsxt_policy_idps_signature_version":                       resourceNsxtPolicyIdpsSignatureVersion(),
			"nsxt_policy_intrusion_service_gateway_policy":             resourceNsxtPolicyIntrusionServiceGatewayPolicy(),
			"nsxt_policy_intrusion_service_gateway_policy_rule":        resourceNsxtPolicyIntrusionServiceGatewayPolicyRule(),
			"nsxt_policy_intrusion_service_policy":                     resourceNsxtPolicyIntrusionServicePolicy(),
			"nsxt_policy_intrusion_service_policy_rule":                resourceNsxtPolicyIntrusionServicePolicyRule(),
			...
			"nsxt_policy_lb_cookie_persistence_profile":                resourceNsxtPolicyLBCookiePersistenceProfile(),
			...
			"nsxt_policy_lb_generic_persistence_profile":               resourceNsxtPolicyLBGenericPersistenceProfile(),
			...
			"nsxt_policy_lb_source_ip_persistence_profile":             resourceNsxtPolicyLBSourceIpPersistenceProfile(),
			...
			"nsxt_policy_parent_intrusion_service_gateway_policy":      resourceNsxtPolicyParentIntrusionServiceGatewayPolicy(),
			"nsxt_policy_parent_intrusion_service_policy":              resourceNsxtPolicyParentIntrusionServicePolicy(),
			...
			"nsxt_policy_project_centralized_network_attachment":       resourceNsxtPolicyProjectCentralizedNetworkAttachment(),
			...
			"nsxt_policy_route_controller":                             resourceNsxtPolicyRouteController(),
			"nsxt_policy_route_controller_bgp_neighbor":                resourceNsxtPolicyRouteControllerBgpNeighbor(),
			"nsxt_policy_route_controller_interface":                   resourceNsxtPolicyRouteControllerInterface(),
			...
			"nsxt_policy_spoof_guard_profile":                          resourceNsxtPolicySpoofGuardProfile("Please use nsxt_policy_spoofguard_profile resource instead"),
			"nsxt_policy_spoofguard_profile":                           resourceNsxtPolicySpoofGuardProfile(""),
			...
			"nsxt_policy_transit_gateway_bfd_peer":                     resourceNsxtPolicyTransitGatewayBfdPeer(),
			"nsxt_policy_transit_gateway_bgp_neighbor":                 resourceNsxtPolicyTransitGatewayBgpNeighbor(),
			"nsxt_policy_transit_gateway_community_list":               resourceNsxtPolicyTransitGatewayCommunityList(),
			...
			"nsxt_policy_transit_gateway_prefix_list":                  resourceNsxtPolicyTransitGatewayPrefixList(),
			"nsxt_policy_transit_gateway_route_map":                    resourceNsxtPolicyTransitGatewayRouteMap(),
			...
			"nsxt_policy_user_management_role_binding_path":            resourceNsxtPolicyUserManagementRoleBindingPath(),
			"nsxt_policy_virtual_network_appliance":                    resourceNsxtPolicyVirtualNetworkAppliance(),
			"nsxt_policy_virtual_network_appliance_cluster":            resourceNsxtPolicyVirtualNetworkApplianceCluster(),
			...
			"nsxt_proxy_config":                                        resourceNsxtProxyConfig(),
...
func providerConfigure(d *schema.ResourceData) (interface{}, error) {
	...
	if util.NsxVersionHigherOrEqual("9.1.0") && !isPolicyGlobalManager(clients) {
