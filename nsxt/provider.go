...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"nsxt_policy_dns_record":                                   resourceNsxtPolicyDnsRecord(),
			"nsxt_policy_dns_record_auto_config":                       resourceNsxtPolicyDnsRecordAutoConfig(),
			"nsxt_policy_dns_rule":                                     resourceNsxtPolicyDnsRule(),
			"nsxt_policy_dns_service":                                  resourceNsxtPolicyDnsService(),
			"nsxt_policy_dns_zone":                                     resourceNsxtPolicyDnsZone(),
